...
public class SpacePermissionsPage extends BasePage {
	...
	private class SpacePermissionsForm extends Form {
		...
		public SpacePermissionsForm(String id) {
			...
			// states col headings =============================================
			final List<Integer> stateKeysNoNew = new ArrayList<Integer>(statesMap.keySet());
			...
			// rows init =======================================================
			List<Integer> stateKeys = new ArrayList<Integer>(statesMap.keySet());
			final List<Role> roles = new ArrayList<Role>(space.getMetadata().getRoleList());
			...
			add(new Button("save") {
				...
				public void onSubmit() {
					...
					space = getJtrac().storeSpace(space);
