...
public class ItemRelatePanel extends BasePanel {
	 ...
	 * wicket form
	 */
	public class RelateForm extends Form {
		...
		public RelateForm(String id) {
			...
			DropDownChoice choice = new DropDownChoice("type", new ArrayList<Integer>(options.keySet()), new IChoiceRenderer() {
				@Override
		...
		protected void onSubmit() {
			Item item = getJtrac().loadItemByRefId(refId);
			long itemId = ((ItemViewPage) getPage()).getItem().getId();
